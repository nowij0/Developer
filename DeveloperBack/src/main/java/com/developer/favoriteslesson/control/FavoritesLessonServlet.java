...
/**
 * Servlet implementation class FavoritesLessonServlet
 */
@WebServlet("/favoritesLesson/*")
public class FavoritesLessonServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	   ...
	   protected void service(HttpServletRequest request, 
	      ...
	      String envFileName = "favoritesLesson.properties";
