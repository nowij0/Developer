...
/**
 * Servlet implementation class AppliedLessonServlet
 */
@WebServlet("/appliedlesson/*")
public class AppliedLessonServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	   ...
	   protected void service(HttpServletRequest request, 
	      ...
	      String envFileName = "appliedLesson.properties";
